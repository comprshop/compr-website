...
const copy = {
  ...
  home: [
    ...
    [".hero h1", "Iets leuks gevonden? <em>Bewaar het en vergelijk.</em>", "Found something you like? <em>Save it and compare.</em>", true],
    [".hero-lead", "Met COMPR bewaar je kleding van verschillende webshops op één plek. Zo vergelijk je rustig prijs, maten, kleur en materiaal.", "COMPR keeps clothes from different stores together in one place, so you can take your time comparing price, sizes, colour and material."],
    ...
    ["#demo h2", "Nu bewaren. Vergelijken wanneer het jou uitkomt.", "Save it now. Compare it when you’re ready."],
    ...
    ["#how-it-works h2", "Zo eenvoudig werkt het.", "Here’s how it works."],
    ...
    ["#compare h2", "Alles wat je wilt vergelijken, bij elkaar.", "The details you need, together in one place."],
    ...
    ["#privacy h2", "Eenvoudig in gebruik. Zorgvuldig met je gegevens.", "Simple to use. Careful with your data."],
    ...
    ["#download h2", "Klaar om online winkelen<br>wat makkelijker te maken?", "Ready to make online shopping<br>a little easier?", true],
...
const extraCopy = {
  de: {
    ...
    home: [
      ...
      [".button-small","Für Chrome – kostenlos"],[".hero .eyebrow","<span></span> Erst vergleichen, dann kaufen",true],[".hero h1","Etwas Schönes gefunden? <em>Speichern und vergleichen.</em>",true],
      [".hero-lead","COMPR sammelt Kleidung aus verschiedenen Shops an einem Ort. So kannst du Preise, Größen, Farben und Materialien in Ruhe vergleichen."],[".hero .button-primary","Für Chrome – kostenlos <span aria-hidden=\"true\">↗</span>",true],[".hero .button-secondary","Für Microsoft Edge herunterladen"],
      ...
      ["#demo .eyebrow","COMPR in Aktion"],["#demo h2","Jetzt speichern. Später in Ruhe vergleichen."],["#demo .section-heading > p:not(.eyebrow)","Sieh dir an, wie Kleidung aus verschiedenen Shops in der COMPR-Übersicht zusammenkommt."],
      ...
      ["#how-it-works .eyebrow","So funktioniert es"],["#how-it-works h2","So einfach geht es."],[".step-card:nth-child(1) h3","Kleidung beim Shoppen speichern"],[".step-card:nth-child(1) p","Öffne COMPR auf einer Produktseite und füge das Kleidungsstück deiner Übersicht hinzu."],
      ...
      ["#compare .eyebrow","Eine klarere Auswahl"],["#compare h2","Alles Wichtige zum Vergleichen an einem Ort."],[".compare-copy > p:not(.eyebrow)","Suche, filtere und sortiere gespeicherte Produkte, ohne ständig Tabs zu wechseln."],
      ...
      ["#privacy .eyebrow","Einfach und sorgfältig"],["#privacy h2","Einfach zu nutzen. Sorgfältig mit deinen Daten."],[".trust-grid article:nth-child(1) h3","Kostenlos."],[".trust-grid article:nth-child(1) p","Installiere COMPR und erstelle kostenlos deinen ersten Vergleich."],
  ...
  fr: {
    ...
    home: [
      ...
      [".button-small","Ajouter à Chrome — gratuit"],[".hero .eyebrow","<span></span> Comparez avant d’acheter",true],[".hero h1","Vous aimez un article ? <em>Enregistrez-le et comparez.</em>",true],[".hero-lead","COMPR réunit les vêtements de plusieurs boutiques au même endroit, pour comparer tranquillement prix, tailles, couleurs et matières."],
      ...
      ["#demo .eyebrow","Voir COMPR en action"],["#demo h2","Enregistrez maintenant. Comparez quand vous voulez."],["#demo .section-heading > p:not(.eyebrow)","Découvrez comment des vêtements de plusieurs boutiques se retrouvent dans la liste COMPR."],[".demo-points li:nth-child(1)","Enregistrez des produits pendant vos achats"],[".demo-points li:nth-child(2)","Retrouvez-les dans une seule liste"],[".demo-points li:nth-child(3)","Comparez les informations disponibles"],[".demo-video-card figcaption","Les pages produit présentées sont des exemples. Les boutiques ne sont pas affiliées à COMPR."],
      ["#how-it-works .eyebrow","Comment ça marche"],["#how-it-works h2","C’est aussi simple que ça."],[".step-card:nth-child(1) h3","Enregistrez vos vêtements"],[".step-card:nth-child(1) p","Ouvrez COMPR sur une page produit et ajoutez l’article à votre liste."],[".step-card:nth-child(2) h3","Comparez les détails utiles"],[".step-card:nth-child(2) p","Comparez clairement les prix, tailles, couleurs et matières."],[".step-card:nth-child(3) h3","Choisissez votre préféré"],[".step-card:nth-child(3) p","Revenez à la page produit d’origine lorsque vous avez fait votre choix."],
      ["#compare .eyebrow","Une liste plus claire"],["#compare h2","Tout ce qu’il faut comparer, au même endroit."],[".compare-copy > p:not(.eyebrow)","Recherchez, filtrez et triez vos produits sans passer constamment d’un onglet à l’autre."],[".feature-list li:nth-child(1)","<span>✓</span> Comparez les prix",true],[".feature-list li:nth-child(2)","<span>✓</span> Comparez couleurs, matières et tailles",true],[".feature-list li:nth-child(3)","<span>✓</span> Filtrez et organisez vos produits",true],[".feature-list li:nth-child(4)","<span>✓</span> Revenez à la page produit d’origine",true],
      ["#privacy .eyebrow","Simple et respectueux"],["#privacy h2","Simple à utiliser. Respectueux de vos données."],[".trust-grid article:nth-child(1) h3","Gratuit."],[".trust-grid article:nth-child(1) p","Installez COMPR et créez gratuitement votre première comparaison."],[".trust-grid article:nth-child(2) h3","Aucun compte requis."],[".trust-grid article:nth-child(2) p","Utilisez COMPR sans créer de compte."],[".trust-grid article:nth-child(3) h3","Enregistré localement."],[".trust-grid article:nth-child(3) p","Vos produits restent dans votre navigateur, pas sur un serveur COMPR."],[".privacy-link-wrap a","Lire la politique de confidentialité →"],
